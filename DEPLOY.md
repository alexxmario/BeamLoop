...
4. **Set environment variables** (Railway → Variables):
   ...
   | `TIKTOK_PRIVACY` | **Leave unset.** The Direct Post audit passed on 15 September 2026, so this is no longer needed. It is a ceiling on what a creator may choose, not a default — setting it silently makes every TikTok post private. See [TIKTOK-AUDIT.md](TIKTOK-AUDIT.md) |
